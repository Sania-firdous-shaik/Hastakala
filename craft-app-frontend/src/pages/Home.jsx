      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Handpicked creations from talented Indian artisans
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">
                Every product is handcrafted by skilled Indian artisans using
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">
                Support local communities and help preserve India's rich
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">
                Safe and secure payment processing for a smooth shopping
                experience.
              </p>
            </div>
