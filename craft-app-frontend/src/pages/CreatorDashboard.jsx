...
const CreatorDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [productsRes, ordersRes, statsRes] = await Promise.all([
        axios.get(`${API_URL}/api/products/creator/my-products`),
        axios.get(`${API_URL}/api/orders/creator/my-orders`),
  ...
  const handleDeletePendingOrder = async (orderId) => {
    if (
      !window.confirm(
        'Delete this pending order? This cannot be undone.'
      )
    ) {
      return;
    }
    ...
    try {
      await axios.delete(
        `${API_URL}/api/orders/creator/${orderId}`
      );
